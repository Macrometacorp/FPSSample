...
public class OptionsMenu : MonoBehaviour
{
    ...
    public void SaveConnectionParams() {
        ...
        if (gdnFields.gdnFederationURL.text != "") {
            GameDebug.Log("tried changing Federatio to blank");
        }
        if (gdnConfig.gdnData.apiKey != gdnFields.gdnAPIKey.text &&  gdnFields.gdnAPIKey.text != "" ) {
